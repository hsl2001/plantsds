...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--species", type=int, default=10, help="Number of species/genomes")
    parser.add_argument("--chromosomes", type=int, default=10, help="Chromosomes per species")
    parser.add_argument("--chrom-length", type=int, default=100_000_000, help="Length of each chromosome")
    parser.add_argument("--fragments", type=int, default=100, help="Number of source fragments")
