...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--chrom-length", type=int, default=10_000_000, help="Length of each chromosome")
    parser.add_argument("--fragments", type=int, default=50, help="Number of source fragments")
